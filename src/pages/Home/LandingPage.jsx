    ...
    <>
      <Carousel loop>
        <div className="relative h-[40rem] w-full">
          <img
            src="https://imgs.search.brave.com/xzG-htXib24TGMun-OYJTyQAioB8YeUEVg-0fFWijGg/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/aXZpbnQub3JnL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIyLzAz/L0FmcmljYW4tTGFk/eS5qcGc"
            alt="error"
          ...
          <div className="absolute inset-0 grid h-[40rem] w-full items-center bg-black/75">
            <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
              ...
              >
                We are an engineering institute advancing science and technology
                education for students from all walks of life.
              </Typography>
        ...
        <div className="relative h-[40rem] w-full">
          <img
            src="https://imgs.search.brave.com/l9ihhI_dJLM-xj3a-2LTv8bn46jURtralMZS6GXW3Bs/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9jZG4u/ZGlnZy5jb20vaW1h/Z2VzL2Q5ZTkxY2Yx/MTA2NTQ5NDg5YTQ5/YmE4YWZiMzg2MzRm/XzFmZTEyMzBkNTNj/ZjRiZGE4ZGMzZTg4/OTJlYWM2NGQzX2hl/YWRlci5qcGVn"
            alt="error"
            className="h-[40rem] w-full object-cover"
          />
